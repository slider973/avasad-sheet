...
class _PdfDocumentPageState extends State<PdfDocumentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Générer et Gérer les PDFs'),
      ),
      body: Column(
        children: [
          Padding(
            ...
            child: Wrap(
              children: [
                ElevatedButton(
                  ...
                  child: const Text('Générer PDF pour le mois actuel'),
                ),
                ElevatedButton(
          ...
          Expanded(child: BlocBuilder<PdfBloc, PdfState>(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          context.read<PdfBloc>().add(DeletePdfEvent(pdf.id));
                        },
                      ),
                      onTap: () {
                        logger.i('Ouverture du PDF ${pdf.filePath}');
                        context.read<PdfBloc>().add(OpenPdfEvent(pdf.filePath));
                      },
                    );
                  },
                );
