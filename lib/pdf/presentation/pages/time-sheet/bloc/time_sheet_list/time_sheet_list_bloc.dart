...
class TimeSheetListBloc extends Bloc<TimeSheetListEvent, TimeSheetListState> {
  ...
  TimeSheetListBloc({required this.findPointedListUseCase})
      : super(const TimeSheetListInitial()) {
  ...
  void _findEntries(
      FindTimesheetEntriesEvent event, Emitter<TimeSheetListState> emit) async {
    try {
