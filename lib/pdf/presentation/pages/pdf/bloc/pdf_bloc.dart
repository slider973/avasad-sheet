...
import 'package:time_sheet/pdf/domain/entities/work_day.dart';
    ...
    children: [
      ...
      pw.TableRow(
        children: [
          pw.Padding(
            padding: const pw.EdgeInsets.all(5),
            child: pw.Text('Mois: mai-2024', style: const pw.TextStyle(fontSize: 8)),
          ),
          pw.Container(),
        ],
      ),
...
pw.TableRow _buildDayRow(Workday day) {
  ...
  return pw.TableRow(
    children: [
      ...
      pw.Center(
          child:
              pw.Text(day.entry.endMorning, style: const pw.TextStyle(fontSize: 6))),
      pw.Center(
      ...
      children: [
        pw.Table(
          ...
          children: [
            pw.TableRow(
              children: [
                _buildSignatureColumn('Travailleur', 'Jonathan LEMAINE'),
